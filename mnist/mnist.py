...
y = hidden_layer(x,weights1,biases1,weights2,biases2,'layer1')
...
#并设置为当前网络的训练轮数
averages_class = tf.train.ExponentialMovingAverage(learning_rate_decay,training_step)
...
regularizer = tf.contrib.layers.l2_regularizer(regularize_rate)       #计算L2正则化损失函数
